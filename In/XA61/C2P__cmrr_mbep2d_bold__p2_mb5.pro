  ...
  <ParamMap.""> 
  {
    ...
    <ParamMap."Properties"> 
    {
      ...
      <ParamMap."Queue"> 
      {
        ...
        <ParamString."ProtocolName">  { "C2P__cmrr_mbep2d_bold__p2_mb5"  }
      }
    }
  }
}
  ...
  <ParamMap.""> 
  {
    ...
    <PipeService."EVA"> 
    {
      ...
      <ParamFunctor."MotionCorrDecorator"> 
      {
        ...
        <ParamLong."Pace">  { 1  }
        <ParamDouble."RotAngle">  { <Precision> 6  3.141593  }
...
tProtocolName	 = 	"C2P__cmrr_mbep2d_bold__p2_mb5"
...
lRepetitions	 = 	6
lScanTimeSec	 = 	1
lTotalScanTimeSec	 = 	37
dRefSNR	 = 	40000.0
dRefSNR_VOI	 = 	40000.0
ulMotionCorr	 = 	1
lParadigmPeriodicity	 = 	3
ucCineMode	 = 	1
ucSequenceType	 = 	4
ucCoilCombineMode	 = 	1
ucFlipAngleMode	 = 	1
...
sRXSPEC.alDwellTime[3]	 = 	3300
sRXSPEC.alDwellTime[4]	 = 	3300
sRXSPEC.alDwellTime[5]	 = 	3300
sRXSPEC.alDwellTime[6]	 = 	3300
sRXSPEC.alDwellTime[7]	 = 	3300
...
sSliceArray.asSlice[0].dInPlaneRot	 = 	3.14159265359
...
sSliceArray.asSlice[1].dInPlaneRot	 = 	3.14159265359
...
sSliceArray.asSlice[2].dInPlaneRot	 = 	3.14159265359
...
sSliceArray.asSlice[3].dInPlaneRot	 = 	3.14159265359
...
sSliceArray.asSlice[4].dInPlaneRot	 = 	3.14159265359
...
sSliceArray.asSlice[5].dInPlaneRot	 = 	3.14159265359
...
sSliceArray.asSlice[6].dInPlaneRot	 = 	3.14159265359
...
sSliceArray.asSlice[7].dInPlaneRot	 = 	3.14159265359
...
sSliceArray.asSlice[8].dInPlaneRot	 = 	3.14159265359
...
sSliceArray.asSlice[9].dInPlaneRot	 = 	3.14159265359
...
sAAInitialOffset.SliceInformation.dInPlaneRot	 = 	-3.14159265359
...
sWipMemBlock.tFree	 = 	"66bb83af-3c31-4d82-a1f4-db94e65b42fe||Sequence: R017 nxva61a/main r/ebb919c16; May 21 2024 10:49:50 by eja"
sWipMemBlock.alFree.__attribute__.size	 = 	64
sWipMemBlock.alFree[0]	 = 	4096
sWipMemBlock.alFree[2]	 = 	3200
sWipMemBlock.alFree[3]	 = 	5120
sWipMemBlock.alFree[7]	 = 	1
sWipMemBlock.alFree[9]	 = 	3
sWipMemBlock.alFree[10]	 = 	17
sWipMemBlock.alFree[13]	 = 	5
