  ...
  <ParamMap.""> 
  {
    ...
    <ParamMap."Properties"> 
    {
      ...
      <ParamMap."Queue"> 
      {
        ...
        <ParamString."ProtocolName">  { "PRODUCT__ep2d_diff__p2_sms2"  }
      }
    }
  }
}
...
tProtocolName	 = 	"PRODUCT__ep2d_diff__p2_sms2"
...
sDiffusion.lDiffDirections	 = 	3
sDiffusion.ulMode	 = 	64
